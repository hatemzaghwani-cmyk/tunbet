      ...
      <div className="pb-24">
        <div className="p-4 space-y-4">
          ...
          <button
            ...
            style={{ background: "linear-gradient(135deg, rgba(0,209,255,0.18), rgba(168,85,247,0.14), rgba(255,45,85,0.10))", border: "1px solid rgba(0,209,255,0.22)" }}
          >
            <div className="absolute -right-10 -top-10 w-32 h-32 rounded-full blur-3xl" style={{ background: "#00D1FF", opacity: 0.24 }} />
            <div className="relative flex items-center justify-between gap-3">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="px-2 py-0.5 rounded-full text-[9px] font-black tracking-wider" style={{ background: "rgba(0,209,255,0.18)", color: "#00D1FF" }}>NEW</span>
                  <span className="text-[10px] text-white/45">No provider fees · Real TND</span>
                </div>
                <h2 className="text-lg font-black tracking-wider text-white">TunBet Originals</h2>
                <p className="text-xs text-white/45 mt-0.5">Dice · Mines · Plinko · Limbo · Keno مثل Stake — مجانا بدون API مدفوع</p>
              </div>
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(0,209,255,0.14)", border: "1px solid rgba(0,209,255,0.35)" }}>
                <Zap className="w-6 h-6" style={{ color: "#00D1FF" }} />
              </div>
            </div>
          </button>
